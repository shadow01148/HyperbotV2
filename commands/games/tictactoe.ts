        ...
        collector.on("collect", async (button: ButtonInteraction) => {
            try {
                ...
                if (button.user.id !== currentPlayer.id) {
                    await button.followUp({ content: "It's not your turn!", flags: MessageFlags.Ephemeral });
                    return;
                }
                ...
                if (board[x][y] !== null) {
                    await button.followUp({ content: "That spot is already taken!", flags: MessageFlags.Ephemeral });
                    return;
                }
